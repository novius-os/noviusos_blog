...
return array(
    ...
    'All right, your new post has been added.' => 'Bon, tu nov post hat esset addit.',

    #: config/common/post.config.php:20
    'The post has been deleted.' => 'Li post hat esset deletet.',

    #. General errors
    #: config/common/post.config.php:23
    'This post doesn’t exist any more. It has been deleted.' => 'Ti post ne existe ancor. It hat esset deletet.',

    #: config/common/post.config.php:24
    'We cannot find this post.' => 'Noi ne posse trovar ti post.',
